          ...
          <tbody>
            {data.length > 0 ? (
              data.map((item, index) => (
                <tr
                  key={item.id}
                  className="border-b border-slate-200 hover:bg-primary-100/20"
                >
                  ...
                  <td className="p-2 flex justify-center items-center gap-2">
                    <Button
                      dataTest={`delete-customer-button-${item.id}`}
                    ...
                    |
                    <Button
                      dataTest={`edit-customer-button-${item.id}`}
                      onClick={() => handhandleClickEdit(item.id || "")}
                      variant="secondary"
                    >
                      Edit
                    </Button>
